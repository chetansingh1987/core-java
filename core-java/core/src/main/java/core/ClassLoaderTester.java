...
public class ClassLoaderTester {
    ...
    public static void main(String args[]) throws Exception {
        ...
        CCLoader ccl = new CCLoader(ClassLoaderTester.class.getClassLoader());
        Class clas = ccl.loadClass("core.Bar");
        Object bar = clas.newInstance();
    ...
    public void test2() throws Exception {
        ...
        CCLoader ccl = new CCLoader(ClassLoaderTester.class.getClassLoader());
        Class clas = ccl.loadClass("java.lang.String");//Would Throw security Exception
    }
}
